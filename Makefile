...
inv-mpu-iio-objs += icm45600/inv_slave_compass_ict1531x.o
inv-mpu-iio-objs += edmp/inv_mpu_edmp_gaf.o
endif
...
obj-$(CONFIG_INV_MPU_IIO_I3C) += inv-mpu-iio-i3c.o
inv-mpu-iio-i3c-objs := inv_mpu_i3c.o
